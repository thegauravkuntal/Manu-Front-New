...
const ProductDetails = () => {
  ...
  // 🔥 DYNAMIC SEO TAGS
  const productTitle = product.metaTitle || `${product.title} | Best Price in India`;
  const productDescription = product.metaDescription || product.shortDescription?.slice(0, 155);
  const productImage = product.ogImage || (product.images?.[0]) || "";
  ...
  const productSchema = {
    ...
    "offers": {
      ...
      "seller": {
        "@type": "Organization",
        "name": product.partnerId?.name || "Verified Seller"
      }
    },
    "brand": {
      "@type": "Brand",
      "name": product.category || "Industrial"
    }
  };
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:description" content={product.ogDescription || productDescription} />
        ...
        <meta name="twitter:description" content={product.ogDescription || productDescription} />
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-xl md:rounded-[32px] shadow-sm overflow-hidden border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-5 md:p-10 flex flex-col justify-center">
              <h1 className="text-xl md:text-4xl font-black text-[#1E3A8A] leading-tight mb-3 md:mb-4">
                {product.title}
              </h1>
